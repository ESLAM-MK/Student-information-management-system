  ...
  return (
    <div className="w-[85%] mx-auto mt-10 flex justify-center items-start flex-col mb-10">
      ...
      <div className="my-6 mx-auto w-full">
        <form
          className="flex justify-center items-center border-2  rounded w-[40%] mx-auto"
        ...
        {id && (
          <div className="mx-auto w-full  bg-gray-700 text-yellow-500 mt-10 flex justify-between items-center p-10 rounded-md shadow-md">
            <div>
              ...
              <div className="mt-3">
                ...
                <p className="text-lg font-normal mb-2">
                  Phone Number: +02 0{data.phoneNumber}
                </p>
                <p className="text-lg font-normal mb-2">
                ...
                <p className="text-lg font-normal mb-2">
                  high school year: {data.highSchool}
                </p>
                <p className="text-lg font-normal mb-2">
                ...
                <p className="text-lg font-normal mb-2">
                parent Phone number: {data.parentPhone}
                </p>
              </div>
            </div>
            <img
