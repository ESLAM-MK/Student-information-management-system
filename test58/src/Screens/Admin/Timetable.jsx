    ...
    <div className="w-[85%] mx-auto mt-10 flex justify-center items-start flex-col mb-10">
      ...
      <div className="w-full flex justify-evenly items-center mt-12">
        <div className="w-1/2 flex flex-col justify-center items-center">
          <p className="mb-4 text-xl text-yellow-500 font-medium">Add Timetable</p>
          <select
            id="branch"
            className="px-2 bg-gray-700 text-white py-3 rounded-sm text-base w-[80%] accent-blue-700 mt-4"
          ...
          >
            ...
            <option value="0">Prepatory</option>
